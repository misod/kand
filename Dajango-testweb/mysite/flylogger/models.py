...
class FlightData(models.Model):
    ...
    glider_pilot = models.ForeignKey('Pilot', models.DO_NOTHING, db_column='Glider_Pilot', blank=True, null=True,related_name = '+')  # Field name made lowercase.
    ...
    towing_pilot = models.ForeignKey('Pilot', models.DO_NOTHING, db_column='Towing_Pilot', blank=True, null=True,related_name = '+')  # Field name made lowercase.
    ...
    towing_time = models.TimeField(db_column='Towing_Time', blank=True, null=True)  # Field name made lowercase.
    flight_time = models.TimeField(db_column='Flight_Time', blank=True, null=True)  # Field name made lowercase.
